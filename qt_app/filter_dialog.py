...
class FilterDialog(QDialog):
    ...
    def _update_btn_styles(self):
        ...
        self.btn_fg.setStyleSheet(f"background-color: {self.fg_color}; color: {contrast(self.fg_color)};")
        self.btn_bg.setStyleSheet(f"background-color: {self.bg_color}; color: {contrast(self.bg_color)};")
